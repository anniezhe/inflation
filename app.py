...
* 2024 Quarter 3: the US Bureau of Economic Analysis (BEA) reported $5.1 trillion in income for federal level, but its current expenditure is about $7 trillion. It's on the path to spend $9.7 trillion for FY 2024 according to [USASpending.gov](https://www.usaspending.gov/).
* From BEA's report, the taxes on corporate income is noticeably low from the federal's perspective, which is about $483 billion for 2024 Quarter 3. The overall (meaning from the federal, state, and local governments combined) is $647 billion.
