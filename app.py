...
* IRS also reported on the existence of fake charities on [its website](https://www.irs.gov/newsroom/irs-dirty-dozen-list-warns-people-to-watch-out-for-tax-related-scams-involving-fake-charities-ghost-preparers-and-other-schemes). [Loeb & Loeb LLP](https://www.loeb.com/en/newsevents/news/2022/07/76-fake-charities-shared-a-mailbox-the-irs-approved-them-all), a law firm, pointed out a flaw in the IRS's ability to detect signs of fraud, which was the struggle to distinguish sound-alike names from actual names.
